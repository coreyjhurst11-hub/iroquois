      ...
      <section id="contact" className="cta-final">
        <Reveal>
          <div className="cta-box">
            ...
            <p>We’ll build you a working demo — free. Websites start at $300 with hosting and a domain included; custom apps and software run $500–$1,500 by scope. You only pay once you approve it — and we stay on as your growth partner as your business grows.</p>
