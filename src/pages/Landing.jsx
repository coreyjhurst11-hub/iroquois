  ...
  return (
    <div className="lp">
      ...
      <header className="lp-nav">
        ...
        <nav className="lp-links"><a href="#film">Demo</a><a href="#package">Package</a><Link to="/operators">Operators</Link></nav>
        <button onClick={openLead} className="btn btn-solid">Get my free demo</button>
      </header>

      {/* hero — one idea, full height */}
      <main className="lp-hero" id="top">
        <Reveal><div className="lp-kick">CUSTOM SOFTWARE · DEMO FIRST</div></Reveal>
        <h1 className="lp-h1">
          <span className="lp-line"><span className="lp-up" style={{ "--d": "60ms" }}>See it work.</span></span>
          <span className="lp-line"><span className="lp-up lp-grad" style={{ "--d": "190ms" }}>Then pay.</span></span>
        </h1>
        <Reveal delay={320}><p className="lp-sub">We hand-build a working demo of your app or website — free. You only pay our flat <span className="lp-gold">$1,000</span> when you love it. And you own the code.</p></Reveal>
      ...
      {/* statement — Jobs-style single idea */}
      <section className="lp-statement" id="statement">
        <Reveal><h2 className="lp-big">Stop renting software that’s <span className="lp-grad">almost</span> right.</h2></Reveal>
        <Reveal delay={150}><p className="lp-big-sub">We build you software that’s <em>exactly</em> right — owned, custom, and made for how your business already works.</p></Reveal>
      </section>

      {/* product reveal — the film as hero */}
      ...
      {/* authority — Ellison-scale proof */}
      <section className="lp-stats-sec">
        <Reveal><div className="lp-kick center">BUILT BY OPERATORS WHO’VE DONE IT</div></Reveal>
        <div className="lp-stats">
          <Stat prefix="$" target={54} suffix="M" decimals={0} accent label="Annual store revenue scaled at The Home Depot" />
      ...
      {/* package */}
      <section className="lp-package" id="package">
        <Reveal><div className="lp-kick center">THE PACKAGE</div></Reveal>
        <Reveal delay={80}><h2 className="lp-h2 center">One honest price. <span className="lp-gold">$1,000.</span> Flat.</h2></Reveal>
        <Reveal delay={140}><p className="lp-h2-sub">Paid only after you’ve seen, tested, and approved your demo. No retainers. No surprises.</p></Reveal>
        <div className="lp-pkg-grid">
          <Reveal className="lp-pkg-col in">
            <h3>Included in Starter</h3>
            <ul>
              <li>A custom-coded app or website for one clear job</li>
              <li>Up to <strong>5 pages</strong> / screens</li>
              <li><strong>1 main feature</strong> — booking, intake, dashboard, CRM view…</li>
              <li>Custom, responsive design — phone &amp; desktop</li>
              <li>Deployed live · full source code, <strong>you own it</strong></li>
            </ul>
            <button onClick={openLead} className="btn btn-solid lp-pkg-btn">Start with a free demo</button>
          </Reveal>
          <Reveal delay={100} className="lp-pkg-col out">
            <h3>Add-ons, when you’re ready</h3>
            <ul>
              <li>More pages, features, or user roles</li>
              <li>Payments, logins, integrations</li>
              <li>Ongoing support &amp; maintenance</li>
              <li>Larger multi-feature platforms</li>
            </ul>
            <p className="lp-pkg-note">The demo proves the small build works — and shows exactly how much further we can take it.</p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="lp-how" id="how">
        ...
        <div className="lp-steps">
          {[["Tell us your goal", "One call. Name the bottleneck you want gone — the manual process, the spreadsheet chaos, the thing eating your week.", "Free"],
            ...
            ["Approve and go live", "Love it? Pay the flat $1,000 and we ship your production build. Don’t? Walk away owing nothing.", "$1,000"]].map(([t, d, tag], i) => (
            <Reveal key={t} delay={i * 90} className="lp-step">
              <div className="lp-step-n">{String(i + 1).padStart(2, "0")}</div>
              <div className="lp-step-b"><div className="lp-step-h"><h3>{t}</h3><span className={`lp-tag ${tag === "$1,000" ? "paid" : "free"}`}>{tag}</span></div><p>{d}</p></div>
            </Reveal>
          ))}
        </div>
      </section>
      ...
      <section className="lp-faqs">
        ...
        <Reveal delay={60}><h2 className="lp-h2">The $1,000, the demo, the fine print.</h2></Reveal>
        <div className="lp-faq-list">
          <Faq q="Is the demo really free?" a="Yes. We build a working demo before you pay anything, and you only pay the $1,000 once you’ve approved it. Not right? You walk away owing nothing." />
          <Faq q="What’s included in the $1,000 Starter?" a="A hand-coded app or website for one clear job: up to 5 pages, 1 main feature, custom responsive design, deployed live — and you own the source code." />
          <Faq q="How fast is it?" a="Most Starter demos land in days, not months. We keep scope tight and hand-code efficiently, and you get a clear timeline on the first call." />
          ...
          <Faq q="Who owns the code?" a="You do, the moment the Starter fee is paid. No lock-in." />
        </div>
      </section>
      ...
      <section className="lp-final" id="start">
        <Reveal><div className="lp-final-box">
          <h2 className="lp-big">Tell us your goal.<br />See it built. Decide later.</h2>
          <p className="lp-big-sub center">No card. No commitment. You only pay if you love it — and you own the code either way.</p>
...
.lp-h1{font-family:'Bricolage Grotesque';font-weight:800;font-size:clamp(52px,12vw,150px);line-height:.92;letter-spacing:-.04em;margin:24px 0 0;}
...
.lp-sub{color:var(--mid);font-size:clamp(17px,2vw,22px);line-height:1.55;max-width:30em;margin:30px auto 0;} .lp-sub strong{color:var(--text);}
...
.lp-big-sub{color:var(--mid);font-size:clamp(17px,2.1vw,24px);line-height:1.5;max-width:30em;margin:28px auto 0;} .lp-big-sub em{color:var(--text);font-style:normal;}
.lp-big-sub.center{text-align:center;}
...
.lp-pkg-col h3{font-family:'Bricolage Grotesque';font-weight:700;font-size:19px;margin-bottom:18px;}
.lp-pkg-col ul{list-style:none;margin:0;padding:0;display:grid;gap:12px;} .lp-pkg-col li{font-size:14.5px;color:var(--mid);line-height:1.5;padding-left:22px;position:relative;} .lp-pkg-col.in li:before{content:"✓";position:absolute;left:0;color:var(--mint);font-weight:700;} .lp-pkg-col.out li:before{content:"+";position:absolute;left:0;color:var(--gold);} .lp-pkg-col strong{color:var(--text);}
.lp-pkg-btn{width:100%;justify-content:center;margin-top:24px;} .lp-pkg-note{margin-top:20px;padding-top:16px;border-top:1px solid var(--line);font-size:13px;color:var(--low);font-style:italic;}

/* how */
.lp-how,.lp-trust,.lp-faqs{position:relative;z-index:2;max-width:1120px;margin:0 auto;padding:clamp(60px,10vh,120px) clamp(20px,5vw,56px);}
...
.lp-faq-a{max-height:0;overflow:hidden;transition:max-height .35s ease,margin .35s;} .lp-faq.open .lp-faq-a{max-height:260px;margin-top:14px;} .lp-faq-a p{font-size:15px;color:var(--mid);line-height:1.6;max-width:58em;}
